...
namespace uut
{
	...
	Matrix4f Matrix4f::createMirror(const Vector3f &planeNormal, const Vector3f &pointOnPlane)
	{
		...
		float dot = Vector3f::dot(planeNormal, pointOnPlane);

		return Matrix4f(1.0f - 2.0f * x * x, -2.0f * y * x, -2.0f * z * x, 0.0f,
	...
	void Matrix4f::orient(const Vector3f &from, const Vector3f &to)
	{
